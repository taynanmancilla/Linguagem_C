...
/*
PONTEIRO GENERICO APONTA PRA QUALQUER TIPO DE MEMORIA, A FUNCAO MALLOC NAO SABE OQ VAMOS FAZER COM A MEMORIA,
...
void* malloc(unsigned int num); // Retorna um ponteiro generico | void*
                                ...
                                // Variavel representa a quantidade de memoria(em bytes) que queremos | num
*/
